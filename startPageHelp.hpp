...
QString pfm_fileBrowseText = 
  startPage::tr ("Use this button to select the input PFM handle file");

QString area_fileText = 
  startPage::tr ("This is the optional area file name for the file that will be used to limit the area of the PFM file "
                 "that will be filtered.  Use the <b>Browse</b> button to select the file.  The area file may be in the "
...
QString ex_fileText = 
  startPage::tr ("This is the optional area file name for the file that will be used to define an area to exclude when filtering "
                 "the PFM.  Use the <b>Browse</b> button to select the file.  The area file may be in ISS-60 format (*.ARE), "
                 "generic format (*.are), or USACE format (*.afs).");
